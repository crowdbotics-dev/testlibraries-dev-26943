...
## Project Structure
    ...
    ├── testlibraries_dev_26943  # Django project configurations
...
1. Clone this repo and `cd testlibraries_dev_26943`
...
2. Clone this repo and `cd testlibraries_dev_26943`
